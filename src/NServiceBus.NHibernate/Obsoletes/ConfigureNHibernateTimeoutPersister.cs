namespace NServiceBus
{
    ...
    public static class ConfigureNHibernateTimeoutPersister
    {
        ...
        [ObsoleteEx(RemoveInVersion = "7", TreatAsErrorFromVersion = "5.0", ReplacementTypeOrMember = "builder.UsePersistence<NHibernatePersistence>().For(Storage.Timeout)")]
...
// ReSharper restore UnusedParameter.Global
        ...
        /// <returns>The configuration object</returns>
        [ObsoleteEx(RemoveInVersion = "7", TreatAsErrorFromVersion = "5.0", ReplacementTypeOrMember = "builder.UsePersistence<NHibernatePersistence>().For(Storage.Timeout).UseTimeoutStorageConfiguration(configuration)[.DisableTimeoutStorageSchemaUpdate()]")]
// ReSharper disable UnusedParameter.Global
...
// ReSharper restore UnusedParameter.Global
        ...
        /// <param name="config">The configuration object.</param>
        /// <returns>The configuration object.</returns>
        [ObsoleteEx(RemoveInVersion = "7", TreatAsErrorFromVersion = "5.0", ReplacementTypeOrMember = "builder.UsePersistence<NHibernatePersistence>().For(Storage.Timeout).DisableTimeoutStorageSchemaUpdate()")]
// ReSharper disable UnusedParameter.Global
