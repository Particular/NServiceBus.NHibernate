namespace NServiceBus
{
    ...
    public static class ConfigureNHibernateGatewayDeduplication
    {
        ...
        [ObsoleteEx(RemoveInVersion = "7", TreatAsErrorFromVersion = "5.0", ReplacementTypeOrMember = "builder.UsePersistence<NHibernatePersistence>().For(Storage.GatewayDeduplication)")]
...
// ReSharper restore UnusedParameter.Global
        ...
        /// <returns>The configuration object</returns>
        [ObsoleteEx(RemoveInVersion = "7", TreatAsErrorFromVersion = "5.0", ReplacementTypeOrMember = "builder.UsePersistence<NHibernatePersistence>().For(Storage.GatewayDeduplication).UseGatewayDeduplicationConfiguration(configuration)")]
// ReSharper disable UnusedParameter.Global
...
// ReSharper restore UnusedParameter.Global
        ...
        /// <param name="config">The configuration object.</param>
        /// <returns>The configuration object.</returns>
        [ObsoleteEx(RemoveInVersion = "7", TreatAsErrorFromVersion = "5.1", ReplacementTypeOrMember = "builder.UsePersistence<NHibernatePersistence>().For(Storage.GatewayDeduplication).DisableGatewayDeduplicationSchemaUpdate()")]
// ReSharper disable UnusedParameter.Global
