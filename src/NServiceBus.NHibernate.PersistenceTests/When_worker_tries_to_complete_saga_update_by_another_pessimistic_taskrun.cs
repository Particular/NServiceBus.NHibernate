namespace NServiceBus.PersistenceTesting.Sagas
{
    ...
    public class When_worker_tries_to_complete_saga_update_by_another_pessimistic_taskrun : SagaPersisterTests
    {
        [Test]
        public async Task Should_complete()
        {
            ...
            tasks.Add(Task.Run(() => FirstSession()));
            tasks.Add(Task.Run(() => SecondSession()));
        ...
        public When_worker_tries_to_complete_saga_update_by_another_pessimistic_taskrun(TestVariant param) : base(param)
        {
        }
    }
}